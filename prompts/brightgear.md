# TAREFA: Lead Brightgear (brightgear) — pesquisa web + PDF + mensagem WhatsApp
...
Leia o arquivo /root/zydon-prospeccao/pesquisas/brightgear_hubspot.json. Use os dados reais (empresa, faturamento, ERP, forma de venda, time, area) no PDF.

## PASSO 2 — Pesquisar a empresa (WEB SEARCH OBRIGATORIO)
Use WebSearch e WebFetch para pesquisar "Brightgear" (dica: industria de equipamentos/gear, pesquisar segmento exato). Descubra: o que faz, segmento, porte, area de atuacao, modelo de operacao, distribuicao. Salve resumo em /root/zydon-prospeccao/pesquisas/brightgear.md com fontes.
...
## PASSO 5 — Gerar PDF
1. Salve o dict em /root/zydon-prospeccao/motor/brightgear_lead.json
2. Rode: python3 /root/zydon-prospeccao/motor/render_one.py brightgear /root/zydon-prospeccao/motor/brightgear_lead.json
3. Confirme o PDF em /root/zydon-prospeccao/pdfs/Potencial-Digitalizacao-brightgear.pdf (ls -la)

## PASSO 6 — Mensagem WhatsApp (template EXATO)
Oi, Daniel, tudo bem? Aqui e a Mariana, da Zydon.

A partir do que voce respondeu no nosso diagnostico, preparei um material sobre o potencial de digitalizacao B2B da Brightgear. Te mando em PDF aqui.

Em resumo, da pra [INSIGHT ESPECIFICO da pesquisa, 1 beneficio tangivel, sem ERP/go-live]. Um consultor nosso te chama na segunda-feira para fazer um diagnostico mais completo da Brightgear e te mostrar isso na pratica. Pode ser?

Salve em /root/zydon-prospeccao/pesquisas/brightgear_msg.txt
