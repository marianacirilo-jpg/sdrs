...
- email: maikel@lbrpro.com.br
- telefone/JID: 48996169983@c.us
- ERP: Outro (SOB PROJETO — TOTVS/outros)
- SDR responsável: Breno (assinatura abaixo)
...
Pesquise "Líbera Pro" / site / segmento. Descubra:
- Catálogo/produtos reais.
- Para quem vende B2B (atacado/distribuidores/indústria).
- Porte, localização, site e Instagram ativos.
Salve em /root/zydon-prospeccao/pesquisas/libera-pro.md

### 2. GERAR PDF (use motor oficial motor/gen.py + motor/render.py)
Crie /root/zydon-prospeccao/motor/_gen_libera-pro.py que importe build_html de gen, defina o dicionário lead, escreva HTML em motor/libera-pro.html, use Playwright para renderizar PDF em /root/zydon-prospeccao/pdfs/Potencial-Digitalizacao-libera-pro.pdf (210mm x 297mm, print_background=True, margin zero, tema dark).
...
### 3. MENSAGEM WHATSAPP
Escreva em /root/zydon-prospeccao/pesquisas/libera-pro_msg.txt seguindo EXATAMENTE:
```
Boa tarde, Maikel, tudo bem? Aqui é o Breno, da Zydon.
A partir do que você respondeu no nosso diagnóstico, preparei um material sobre o potencial de digitalização B2B da Líbera Pro. Te mando em PDF aqui.
Em resumo, dá pra [INSIGHT ESPECÍFICO da pesquisa — concreto, 1 frase]. Um consultor nosso jaja entra em contato com você para fazer um diagnóstico mais completo da Líbera Pro e te mostrar isso na prática. Pode ser?
```
- Assinatura OBRIGATÓRIA: "Aqui é o Breno, da Zydon"
