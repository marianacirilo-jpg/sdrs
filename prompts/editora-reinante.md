...
- contato: Bruno Silva
- email: contato@editorareinante.com.br
- telefone/JID: 21972011406@c.us
- ERP: Outro (SOB PROJETO — TOTVS/outros)
- SDR responsável: Sarah (assinatura abaixo)
...
Pesquise "Editora Reinante" / site / segmento. Descubra:
- Catálogo/produtos reais.
- Para quem vende B2B (atacado/distribuidores/indústria).
- Porte, localização, site e Instagram ativos.
Salve em /root/zydon-prospeccao/pesquisas/editora-reinante.md

### 2. GERAR PDF (use motor oficial motor/gen.py + motor/render.py)
Crie /root/zydon-prospeccao/motor/_gen_editora-reinante.py que importe build_html de gen, defina o dicionário lead, escreva HTML em motor/editora-reinante.html, use Playwright para renderizar PDF em /root/zydon-prospeccao/pdfs/Potencial-Digitalizacao-editora-reinante.pdf (210mm x 297mm, print_background=True, margin zero, tema dark).
...
### 3. MENSAGEM WHATSAPP
Escreva em /root/zydon-prospeccao/pesquisas/editora-reinante_msg.txt seguindo EXATAMENTE:
```
Boa tarde, Bruno, tudo bem? Aqui é a Sarah, da Zydon.
A partir do que você respondeu no nosso diagnóstico, preparei um material sobre o potencial de digitalização B2B da Editora Reinante. Te mando em PDF aqui.
Em resumo, dá pra [INSIGHT ESPECÍFICO da pesquisa — concreto, 1 frase]. Um consultor nosso jaja entra em contato com você para fazer um diagnóstico mais completo da Editora Reinante e te mostrar isso na prática. Pode ser?
```
- Assinatura OBRIGATÓRIA: "Aqui é a Sarah, da Zydon"
