...
.tag{font-size:12.5px;letter-spacing:.18em;font-weight:700;color:var(--fg);border:1px solid var(--fg);border-radius:4px;padding:6px 10px;}
.pbody{flex:1;padding-top:7mm;}
.pfoot{display:flex;justify-content:space-between;font-size:11.5px;color:var(--muted);padding-top:7px;border-top:1px solid var(--hair);letter-spacing:.02em;}
.pfoot span:last-child{font-weight:600;}
.sectitle{display:flex;align-items:center;gap:9px;font-size:14px;font-weight:700;letter-spacing:.16em;color:var(--lime);margin:0 0 13px;}
.sectitle .dash{width:18px;height:2px;background:var(--lime);display:inline-block;flex:0 0 18px;}
.hl{color:var(--lime);}
b{font-weight:600;}
.src{font-size:12.5px;color:var(--muted);margin-top:10px;line-height:1.45;}
.src.bottom{margin-top:8px;}

/* PAGE 1 */
.hero{margin-bottom:9mm;}
.hero .kline{width:34px;height:4px;background:var(--lime);margin-bottom:13px;}
h1{font-size:46px;font-weight:700;line-height:1.02;letter-spacing:-.025em;}
.breadcrumb{margin-top:14px;font-size:15px;font-weight:500;}
.prepared{margin-top:7px;font-size:12.5px;color:var(--muted);}
.aboutbox{background:var(--card);border:1px solid var(--cardln);border-radius:12px;padding:18px 20px;margin-bottom:8mm;}
.aboutbox p{font-size:15.5px;line-height:1.65;}
...
.plabel{font-size:12px;letter-spacing:.1em;color:var(--muted);font-weight:600;}
.pval{font-size:18.5px;font-weight:600;line-height:1.3;}
...
.findings p{font-size:16px;line-height:1.6;}
.callout{border:1.5px solid var(--lime);border-radius:12px;padding:16px 20px;margin-bottom:6mm;background:rgba(205,235,0,.06);}
.colabel{font-size:12px;letter-spacing:.14em;font-weight:700;color:var(--lime);margin-bottom:8px;}
...
.contabox h3{font-size:19px;font-weight:700;margin-bottom:7px;letter-spacing:-.01em;}
.contabox p{font-size:15px;line-height:1.6;}
...
.statnum{font-size:34px;font-weight:700;color:var(--lime);letter-spacing:-.02em;line-height:1;margin-bottom:7px;}
.statcard p{font-size:13px;line-height:1.5;}

/* PAGE 3 */
.meanbox{background:var(--card);border:1px solid var(--cardln);border-radius:14px;padding:18px 20px;margin-bottom:6mm;}
.meanbox > p{font-size:16px;line-height:1.6;}
.bignum{display:flex;align-items:baseline;gap:15px;margin:15px 0 11px;}
.range{font-size:50px;font-weight:700;color:var(--lime);letter-spacing:-.03em;line-height:.95;}
.bnsub{font-size:14px;color:var(--muted);line-height:1.35;}
...
.permes{font-size:15px;font-weight:600;margin-bottom:6px;}
...
.chk p{font-size:14.5px;line-height:1.5;}
...
.erplabel{font-size:12px;letter-spacing:.1em;color:var(--muted);font-weight:600;}
.erpval{font-size:17px;font-weight:700;letter-spacing:-.01em;}
.erpdesc{font-size:13px;line-height:1.6;margin-bottom:6px;white-space:pre-line;}
.erpnote{font-size:13.5px;line-height:1.55;color:var(--muted);}
</style></head>
