#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Reclassificação explícita Rafael: Evermax é MQL e deve receber diagnóstico."""
import json
import os
import sys
...
EMAILS = ['iron.san@evermax.com.br']
PROPS = [
...
def lead_for(email):
    ...
    return {
        ...
        'manual_override_reason': 'Rafael afirmou que Evermax Distribuidor é MQL; distribuição clara desde 1997, site histórico e fit B2B.',
    }
