...
PORT=4605; JID='5511996077972@c.us'; EMAIL='joao.santos@grupoautomec.com.br'; CID='232133868046'; DEAL_ID='61851006769'; OWNER='86265630'
QUESTION_ID='3EB000A3DAF0CE1055DBCE'
...
def history():
    p=Path('/root/.hermes/whatsapp-extra/channel_data/history_4605.json')
...
rows.append({'date':datetime.now(ZoneInfo('America/Sao_Paulo')).strftime('%Y-%m-%d %H:%M'),'date_tz':datetime.now(ZoneInfo('America/Sao_Paulo')).isoformat(),'email':EMAIL,'contact_id':CID,'deal_id':DEAL_ID,'slug':'grupo-automec-atacado-joao-santos','status':'mql_agenda_sdr_apos_diagnostico','to':JID,'bridge_port':PORT,'owner_id':OWNER,'text':AGENDA,'response':result})
